...
export const QuestionsContainer = () => {
    ...
    const MemoQuestions = useMemo(() => <Questions openPage={openPage} changePage={changePage} openImg={openImg} redactAsk={redactAsk} testStart={testStart} {...questionPage} portionsSize={portionsSize} deleteAsk={deleteAsk} />, [questionPage]);// eslint-disable-line react-hooks/exhaustive-deps
